		...
		<table id="documentListTable" class="x_table x_table-striped x_table-hover">
			<thead>
				<tr>
					...
					<th scope="col" class="nowr">비추천</th>
			...
			<tbody>
				...
				<tr>
					<td>
						<a href="<?php echo str::getUrl('',__MODULEID,$val['module'],'srl',$val['document_srl']);?>"><?php echo $val['nick_name']; ?></a>
					</td>
					<td>
					...
					<td>
						<?php echo date("y.m.d H:i:s", strtotime($val['regdate'])); ?>
					</td>
					<td>
