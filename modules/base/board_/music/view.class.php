<?php
	...
	class board_view extends view_abstract implements viewInterface
	{
		...
		function dispOriginContent() 
		{
			...
			$this->board->item_popular = $this->board->model->getOriginAlbumFiles($this->board->album);
			...
			{
				$this->board->file_list = $this->board->model->getFilesInTarget($this->board->item_popular);
			}
		...
		function dispAlbumContent() {
			...
			$this->board->item_popular = $this->board->model->getAlbumFiles($this->board->album);
		...
		function dispBoardSetup() {
			...
			$this->board->module_id = $this->getParam(__MODULEID);
			$this->board->skin = $this->board->model->getModuleLayoutByBoardNameName($this->board->module_id);
		...
		function getChildCategory($subSrl, $toChildren = false) 
		{
			...
			$this->board->module_id = $this->getParam(__MODULEID);
			$subCategory = $this->board->model->getCategoryChildren($this->board->module_id, $subSrl);
		...
		function getCategory()
		{
			...
			$this->board->module_id = $this->getParam(__MODULEID);
			$this->board->extralist = $this->board->model->getCategoryListWithoutChildren($this->board->module_id);
		...
		function dispBoardSkinSetup() 
		{
			...
			$this->board->module_id = $this->getParam(__MODULEID);
			$this->board->skin = $this->board->model->getModuleLayoutByBoardName($this->board->module_id);
		...
		function dispBoardPopular() 
		{
			...
			$this->board->module_id = $this->getParam(__MODULEID);
			$this->board->page = $this->getParam('page') ? $this->getParam('page') : 1;
			$this->board->document_count = $this->board->model->getPopularDocumentListCount($this->board->module_id, $this->board->popular_count);
		...
		function dispBoardContent() 
		{
			...
			else if (isset($this->board->sort_index)) 
			{
				...
				switch($this->board->sort_index):
					...
					case "download_count":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getPopularDocumentListBySortIndex($this->board->module_id, 0, $this->board->page_start, $this->board->list_count);
						break;
					case "playtime":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getDocumentListByOrder($this->board->module_id, $this->board->page_start, $this->board->list_count, "playtime");
						break;
					//조회수 정렬
					case "readed_count":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getDocumentListByOrder($this->board->module_id, $this->board->page_start, $this->board->list_count, "readed");
						break;
					//가수 정렬
					case "artist":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getDocumentListByOrder($this->board->module_id, $this->board->page_start, $this->board->list_count, "artist");
						break;
					//추천수 정렬
					case "voted_count":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getDocumentListByOrder($this->board->module_id, $this->board->page_start, $this->board->list_count, "voted");
						break;
					case "category":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getDocumentListByOrder($this->board->module_id, $this->board->page_start, $this->board->list_count, "category");
						break;
					case "regdate":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getDocumentListByOrder($this->board->module_id, $this->board->page_start, $this->board->list_count, "regdate");
						break;
					case "star_count":
						$this->board->page_start = ($this->board->page-1) * $this->board->list_count;
						$this->board->query = $this->board->model->getDocumentListByOrder($this->board->module_id, $this->board->page_start, $this->board->list_count, "star");
						break;
				endswitch;
